...
export const ROLE_MODULE_POLICIES: Record<AppRole, ModulePolicy> = {
  ...
  ANALIS_MADYA: {
    ...
    PEMBERHENTIAN: MADYA_PERMISSIONS,
    LAYANAN_KEPEGAWAIAN: MADYA_PERMISSIONS,
    REKONSILIASI_BPKAD: MADYA_PERMISSIONS,
    SIDATA: MADYA_PERMISSIONS,
    SIANALITIK: ['read', 'monitor', 'report'],
    SIARSIP: ['read', 'input', 'upload'],
    SIFORMEN: MADYA_PERMISSIONS,
  },
  ANALIS_MUDA: {
    DASHBOARD: ['read'],
    ...
    PEMBERHENTIAN: TECHNICAL_PERMISSIONS,
    LAYANAN_KEPEGAWAIAN: TECHNICAL_PERMISSIONS,
    REKONSILIASI_BPKAD: TECHNICAL_PERMISSIONS,
    SIDATA: TECHNICAL_PERMISSIONS,
    SIARSIP: ['read', 'input', 'upload'],
    SIFORMEN: TECHNICAL_PERMISSIONS,
  },
  ANALIS_PERTAMA: {
    DASHBOARD: ['read'],
    ...
    PEMBERHENTIAN: FIRST_REVIEW_PERMISSIONS,
    LAYANAN_KEPEGAWAIAN: FIRST_REVIEW_PERMISSIONS,
    REKONSILIASI_BPKAD: FIRST_REVIEW_PERMISSIONS,
    SIDATA: FIRST_REVIEW_PERMISSIONS,
    SIARSIP: ['read', 'input', 'upload'],
    SIFORMEN: FIRST_REVIEW_PERMISSIONS,
  },
  PENELAAH: {
    DASHBOARD: ['read'],
    KINERJA_BIDANG: FIRST_REVIEW_PERMISSIONS,
  ...
  PPPK: {
    ...
    PEMBERHENTIAN: ['read', 'monitor'],
    LAYANAN_KEPEGAWAIAN: LIMITED_INPUT_PERMISSIONS,
    REKONSILIASI_BPKAD: LIMITED_INPUT_PERMISSIONS,
    SIARSIP: ['upload'],
  },
  OPD: {
    SIPENSIUN: LIMITED_INPUT_PERMISSIONS,
